...
echo '<div class="row">
		...
		<div class="col-md-4">
          <div class="box box-widget widget-user-2">
			...
			<div class="box-footer no-padding">
			<ul class="nav nav-stacked">
			  <li><a href="#">Total Pembayaran 
			  ';?>

<span class="pull-right badge bg-blue"><?=rupiah($jmlbayarsiswa);?></span><span
	class="pull-right badge bg-blue"><?=round(((100/$i_nominal_tagihan)*($jmlbayarsiswa)),2);?>%</span></a>
</li>
<?php 
$persenpembayaran=round(((100/$i_nominal_tagihan)*($jmlbayarsiswa)),2);
?>

<li><a href="#" class="pull-right">Total Tagihan <span class="pull-right badge bg-yellow">
			<?=rupiah($i_nominal_tagihan);?></span></a></li>
<li><a href="#" class="pull-right">Total Tagihan Belum dibayar <span
			class="pull-right badge bg-red"><?=rupiah($i_nominal_tagihan-$jmlbayarsiswa);?></span></a></li>
<li> <a href="#" class="pull-right"></a>
</li>
<?php
			echo'</ul>
		  </div>';
		  if($persenpembayaran>=$persentase){
		  echo'<div class="box-footer no-padding">
		  <a href="cetak_ujian.php" class="pull-right btn btn-block btn-danger">Cetak 
			Data Ujian</a>
		  </div>';
		  }
		  echo'</div>
...
if($persenpembayaran>=$persentase){
	...
	<div class="box box-widget widget-user-2">
	  ...
	  <img class="img-circle" src="'.$pathku.'" alt="'.$nm1_session.'">
		...
		<h3 class="widget-user-username">DATA UJIAN </h3>
		<h5 class="widget-user-desc">Belum bisa melihat data ujian jika persentase pembayaran dibawah '.$persentase.'%</h5>
	  </div>
