...
$ike++;
		...
		<span class="pull-right badge bg-blue"><?=round(((100/$i_nominal_tagihan)*($jmlbayarsiswa)),2);?>%</span></li>
		<li>Total Tagihan <span class="pull-right badge bg-yellow"><?=rupiah($i_nominal_tagihan);?></span></li>
		<li>Total Tagihan Belum dibayar <span class="pull-right badge bg-red"><?=rupiah($i_nominal_tagihan-$jmlbayarsiswa);?></span></li>
	</div></div>';
	<?php
			}
