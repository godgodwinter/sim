...
if ($_POST['btnOK'])
	...
	$passwordori = cegah($_POST["passwordx"]);
	...
	if ((empty($tipe)) OR (empty($username)) OR (empty($password)))
		...
		if ($tipe == "tp04")
			...
			if($passwordori==='ortu'){
					...
					//re-direct
					pekem('Password salah! Coba lagi atau Hubungi admin',$filenya);
					exit();
			}
    ...
    <form action="<?php echo $filenya;?>" method="post" name="formx">
      ...
      <div class="form-group has-feedback">
		<select name="tipe" class="btn-warning form-control" placeholder="Tipe">
			...
			<option value="tp04">Orang Tua atau Wali Murid</option>
			<option value="tp01">Wali Kelas</option>
